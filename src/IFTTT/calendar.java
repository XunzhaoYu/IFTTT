...
public class calendar extends JPanel
{
	        ...
	        private int length=100;                   //下拉拓展框的长度
	        public calendar(Container owner,int length) {
	           this.owner = owner;
	        ...
	        public calendar(Container owner, String partten,int length) {
	            this.owner = owner;
	            this.parten = partten;
	            this.length=length;
	            try {
	        ...
	        public calendar(Container owner, String partten) {
	            this.owner = owner;
	            this.parten = partten;
	            try {
	                init();
	        ...
	        public calendar(Container owner) {
	            this.owner = owner;
	            this.parten = "yyyy-MM-dd";
	            try {
	                init();
	        ...
	        private void init() throws Exception {
	            ...
	            btnChoose.addActionListener(new ActionListener() {
	                public void actionPerformed(ActionEvent e) {
	                	calendar.this.btnChoose_actionPerformed(e);
	                }
	            });
	            Date date = new Date();
	    ...
	    //月历表格配色----------------//
	            ...
	            Color todayBtnColor = Color.GRAY; //今天的日历底色
	    //控制条配色------------------//
	            ...
	            public void mouseClicked(MouseEvent e) {
	                if (e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 1) {
	                    ...
	                    SimpleDateFormat simpleDateFormat = new SimpleDateFormat(
	                        pattern);
	                    calendar.this.setText(simpleDateFormat.format(selectDate));
